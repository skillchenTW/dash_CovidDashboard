...
# get overall wordwide total for confirmed, recovered and dead cases
...
# Generate Line Grap using Plotly
def fig_world_trend(cntry='US', window=3):
    ...
    fig = px.line(df, y='Total', x=df.index, title='Daily confirmed cases trend for{}'.format(cntry),
    height=600, color_discrete_sequence=['maroon'])
